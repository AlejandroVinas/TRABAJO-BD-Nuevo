(function () {
    ...
    var GenerosService = require('./generos.module')().GenerosService;
...
function modifyGeneros(req, res, next) {
        GenerosService.updateGeneros(req.params.generosId, req.body)
            .then(success)
            .catch(error);
    ...
    function removeGeneros(req, res, next) {
        ...
        UserService.deleteGeneros(req.params.generosId)
            .then(success)
            .catch(error);
